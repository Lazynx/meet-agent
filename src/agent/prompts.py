...
4. Извлеки структурированные данные с ТОЧНЫМИ дедлайнами и приоритетами. Собери извлеченные данные в внутреннюю структуру meeting_data (в формате JSON, описанном ниже). НЕ ВЫВОДИ ЭТУ СТРУКТУРУ!
